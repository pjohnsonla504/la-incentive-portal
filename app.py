...
if check_password():
    ...
    if gj:
        fig_asset = px.choropleth_mapbox(
        ...
        fig_asset.add_trace(go.Scattermapbox(
        ...
        fig_asset.update_layout(margin={"r":0,"t":0,"l":0,"b":0}, paper_bgcolor='rgba(0,0,0,0)', height=700, showlegend=False)
