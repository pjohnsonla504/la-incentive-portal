...
if check_password():
    ...
    st.markdown("<div class='section-title'>Tract Profiling & Recommendations</div>", unsafe_allow_html=True)
    ...
    with c6b:
        ...
        if not row.empty:
            ...
            # CORRECTED CURRENCY METRICS BELOW
            metrics = [
    ...
    if st.session_state["session_recs"]:
        st.markdown("<div class='section-title'>My Recommendations</div>", unsafe_allow_html=True)
