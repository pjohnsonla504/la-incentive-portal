...
with b1:
    st.markdown("""<div class='benefit-card'><div class='benefit-label'>Benefit 01</div><div class='benefit-header'>5-Year Rolling Deferral</div><div class='benefit-body'>Investors can defer taxes on original capital gains through a 5-year rolling window, providing flexible liquidity for phased Louisiana developments.</div></div>""", unsafe_allow_html=True)
with b2:
    st.markdown("""<div class='benefit-card'><div class='benefit-label'>Benefit 02</div><div class='benefit-header'>10% Urban / 30% Rural Step-Up</div><div class='benefit-body'>Standard QOFs receive a 10% basis step-up after 5 years. Qualified Rural Funds (QROFs) receive an enhanced 30% basis step-up, permanently excluding nearly a third of the original gain.</div></div>""", unsafe_allow_html=True)
with b3:
    st.markdown("""<div class='benefit-card'><div class='benefit-label'>Benefit 03</div><div class='benefit-header'>Permanent Exclusion</div><div class='benefit-body'>Holding the investment for at least 10 years results in zero federal capital gains tax on appreciation, with a specific focus on rural health and digital infrastructure.</div></div>""", unsafe_allow_html=True)
...
with uc1:
    st.markdown("""<div class='benefit-card' style='border-left: 5px solid #4ade80;'><div class='benefit-label'>Use-Case: Rural Healthcare</div><div class='benefit-body'><span style='font-size:1.2rem; font-weight:800; display:block; margin-bottom:10px;'>Objective: Modernize critical care.</span>Utilizing the 30% Rural Step-Up, this QROF investment offsets higher construction costs in remote areas while meeting the OBBB's rural equity mandate.</div></div>""", unsafe_allow_html=True)
with uc2:
    st.markdown("""<div class='benefit-card' style='border-left: 5px solid #4ade80;'><div class='benefit-label'>Use-Case: Main Street Reuse</div><div class='benefit-body'><span style='font-size:1.2rem; font-weight:800; display:block; margin-bottom:10px;'>Objective: Historic Revitalization.</span>Leveraging Louisiana Main Street designations to drive investment into core commercial districts for small business and fiber hubs.</div></div>""", unsafe_allow_html=True)

# --- SECTION 4: STRATEGIC SELECTION TOOL (PLACEHOLDER) ---
st.markdown("""
...
st.info("Section 4 is ready for data integration. Please see the questions below to help me troubleshoot the map and protection.")