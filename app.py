...
def haversine(lon1, lat1, lon2, lat2):
    ...
    return 3956 * 2 * asin(sqrt(a)) # Returns Miles
...
def load_assets():
    ...
    if not master.empty:
        ...
        fip_col = [c for c in master.columns if 'fipcode' in c.lower()][0]
...
# (Your Benefit Cards logic here - b1, b2, b3)
...
with b2: st.markdown("<div class='benefit-card'><div class='benefit-label'>Benefit 02</div><div class='benefit-header'>30% Rural Step-Up</div><div class='benefit-body'>Qualified Rural Funds receive an enhanced 30% basis step-up, excluding nearly a third of the gain.</div></div>", unsafe_allow_html=True)
with b3: st.markdown("<div class='benefit-card'><div class='benefit-label'>Benefit 03</div><div class='benefit-header'>Permanent Exclusion</div><div class='benefit-body'>Holding the investment for at least 10 years results in zero federal capital gains tax on appreciation.</div></div>", unsafe_allow_html=True)
...
with uc1: st.markdown("<div class='benefit-card' style='border-left: 5px solid #4ade80;'><div class='benefit-label'>Use-Case: Rural Healthcare</div><div class='benefit-body'><b>Objective: Modernize critical care.</b> Utilizing the 30% Rural Step-Up to offset construction costs.</div></div>", unsafe_allow_html=True)
...
# --- SECTION 4: STRATEGIC SELECTION TOOL (THE FOCUS) ---
st.markdown("""
